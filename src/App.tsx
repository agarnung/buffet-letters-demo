    ...
    <div className="bg-emerald-100">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                ...
                <a href="https://github.com/agarnung/buffet-letters" className="font-medium underline">proyecto completo</a>.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-emerald-200 mt-12">
        <div className="mx-auto max-w-5xl px-4 py-4 text-xs text-emerald-700">
          ...
          <a href="https://github.com/agarnung/buffet-letters" className="ml-1 text-blue-600 hover:underline">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 m-4">
              ...
              <div className="mt-2 text-sm text-red-600">
                <p>Ruta intentada: /letters/es/{year}.md</p>
              </div>
            </div>
          )}
